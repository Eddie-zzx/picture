package com.graduation.picture.manager.upload;
...
import com.graduation.picture.config.CosClientConfig;
...
import com.graduation.picture.utils.HexColorUtil;
...
public abstract class PictureUploadTemplate {
     ...
     * @return
     */
    public UploadPictureVO uploadPicture(Object inputSource, String uploadPathPrefix) {
        // 1. 校验图片
     ...
     * @return
     */
    private UploadPictureVO buildResult(String originFilename, CIObject compressedCiObject, CIObject thumbnailCiObject, ImageInfo imageInfo) {
        ...
        uploadPictureVO.setPicColor(HexColorUtil.expandHexColor(imageInfo.getAve()));
     ...
     * @return
     */
    private UploadPictureVO buildResult(String originalFilename, File file, String uploadPath, ImageInfo imageInfo) {
        // 计算宽高
