package com.graduation.picture.manager.websocket;
...
import com.graduation.picture.enums.PictureEditActionEnum;
import com.graduation.picture.enums.PictureEditMessageTypeEnum;
import com.graduation.picture.manager.websocket.disruptor.PictureEditEventProducer;
import com.graduation.picture.manager.websocket.model.PictureEditRequestMessage;
import com.graduation.picture.manager.websocket.model.PictureEditResponseMessage;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    public void handleEnterEditMessage(
            PictureEditRequestMessage pictureEditRequestMessage, WebSocketSession session, User user, Long pictureId) throws IOException {
        // 没有用户正在编辑该图片 才能进入编辑
