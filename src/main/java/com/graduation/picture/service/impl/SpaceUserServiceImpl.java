...
import com.graduation.picture.mapper.SpaceUserMapper;
...
/**
 * @Classname SpaceUserServiceImpl
...
public class SpaceUserServiceImpl extends ServiceImpl<SpaceUserMapper, SpaceUser>
    ...
    public long addSpaceUser(SpaceUserAddDTO spaceUserAddDTO) {
        ...
        Long userId = userMapper.getUserIdByUserAccount(spaceUserAddDTO.getUserAccount());
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.OPERATION_ERROR, "请查看团队是否已有该用户");
        }
    ...
    @Override
    public QueryWrapper<SpaceUser> getQueryWrapper(SpaceUserQueryQo spaceUserQueryQo) {
        QueryWrapper<SpaceUser> queryWrapper = new QueryWrapper<>();
        if (spaceUserQueryQo == null) {
            return queryWrapper;
        }
        // 从对象中取值
        Long id = spaceUserQueryQo.getId();
        Long spaceId = spaceUserQueryQo.getSpaceId();
        Long userId = spaceUserQueryQo.getUserId();
        String spaceRole = spaceUserQueryQo.getSpaceRole();
