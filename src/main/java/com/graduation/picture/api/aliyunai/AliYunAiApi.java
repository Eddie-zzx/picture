package com.graduation.picture.api.aliyunai;
...
public class AliYunAiApi {
     ...
     * @return
     */
    public CreateOutPaintingTaskResponse createOutPaintingTask(CreateOutPaintingTaskDTO createOutPaintingTaskDTO) {
        if (createOutPaintingTaskDTO == null) {
